...
*   `Apple Silicon macs (M1 or newer chips) <https://sourceforge.net/projects/bioxtasraw/files/RAW-2.1.3-mac-arm64.dmg/download>`_

*   `Intel macs (pre-M1 chips) <https://sourceforge.net/projects/bioxtasraw/files/RAW-2.1.3-mac-x86_64.dmg/download>`_
