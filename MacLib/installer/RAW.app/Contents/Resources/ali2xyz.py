#!/usr/bin/env python
# This script is from the DENSS package, and must be run with the EMAN2 python
# distribution to work. For this reason, it isn't strictly part of the RAW code
# and so is included in the resources directory, rather than the main one.
# This also aids with packaging.
