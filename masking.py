...
class MaskingPanelToolbar(NavigationToolbar2Wx):
    def __init__(self, parent, canvas):
        ...
        self.AddCheckTool(self._MTB_RECTANGLE, rectangleIcon)
        self.AddCheckTool(self._MTB_POLYGON, polygonIcon)
        self.AddSeparator()
        self.AddSimpleTool(self._MTB_SAVEMASK, saveMaskIcon)
        self.AddSimpleTool(self._MTB_LOADMASK, loadMaskIcon)
        self.AddSimpleTool(self._MTB_CLEAR, clearIcon)
        self.AddCheckTool(self._MTB_AGBECENT, agbeCentIcon)
        self.AddSeparator()
