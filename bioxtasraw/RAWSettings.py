    ...
    def __init__(self, settings = None):
        ...
        if settings is None:
            ...
            self._params = {
                ...
                'crysolEnergy'          : ['None', get_id(), 'text'],
                'crysolShell'           : ['directional', get_id(), 'choice'],
                'crysolExplicitH'       : [False, get_id(), 'bool'],
                'crysolImplicitH'       : ['None', get_id(), 'text'],
                'crysolSubElement'      : ['None', get_id(), 'text'],
                'crysolModelID'         : ['None', get_id(), 'text'],
                'crysolChainID'         : ['None', get_id(), 'text'],
                ...
                'pdb2mrcVoxel'           : ['None', get_id(), 'text'],
                'pdb2mrcSide'            : ['None', get_id(), 'text'],
                ...
                'denssShrinkwrapSigmaStart' : ['None', get_id(), 'text'],
                'denssShrinkwrapSigmaEnd'   : ['None', get_id(), 'text'],
                'denssShrinkwrapSigmaDecay' : [0.99, get_id(), 'float'],
                'denssShrinkwrapThresFrac'  : [0.2, get_id(), 'float'],
